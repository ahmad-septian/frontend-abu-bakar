...
export default function DetailUAS() {
  ...
  const fetchData = async () => {
    try {
      ...
      setNilai(response.data.nilai.uas);
    } catch (error) {
  ...
  const handleExport = async () => {
    try {
      const response = await ExportSiswa("uas");
  ...
  return (
    <div className="p-4 max-w-4xl mx-auto text-sm">
      ...
      <h2 className="font-bold mb-2">Nilai UAS</h2>
